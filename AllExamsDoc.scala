...
class AllExamsDoc extends Initializable {
  ...
  override def initialize(location: URL, resources: ResourceBundle): Unit = {
    val exs = mf1.filterExamDocF(usr).sortWith((a, b) => Calendar.isFirst(a._4, b._4))
    val exs2 = mf2.filterExamDocF(usr).sortWith((a, b) => Calendar.isFirst(a._4, b._4))
    if (exs.nonEmpty) {
